...
public class PrintDecimalStrings {
    ...
    public static void main(String[] args) {
        ...
        //PostitiveTestCase 1
        int inputRange = 2;
        printAllDecimalNumber(inputRange);

    }

    private static void printAllDecimalNumber(int inputRange) {

        helper(inputRange,"");

    }

    private static void helper(int n, String soFar){
